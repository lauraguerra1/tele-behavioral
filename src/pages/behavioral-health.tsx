    ...
    },
    {
      ...
      subsections: [
        ...
        },
        {
          ...
          paragraphs: (
            <p>
              <span className='font-extrabold text-lg'>Dialectical behavior therapy (DBT)</span> is a form of psychotherapy that focuses on helping individuals who struggle with intense emotions. This therapy incorporates elements of mindfulness, acceptance, and cognitive-behavioral therapy to address emotional regulation, interpersonal effectiveness, distress tolerance, and mindfulness skills. It has been proven effective in treating various mental health conditions, including self-harm, substance abuse, eating disorders, and mood disorders. DBT utilizes a structured approach, emphasizing the importance of creating a supportive and validating environment for clients. It aims to help clients develop coping skills and techniques to regulate their emotions through individual sessions and group therapy. DBT is recognized as an effective treatment option for individuals dealing with emotional struggles and aims to equip them with the necessary tools to navigate these challenges. DBT recognizes the necessity for change within a framework of accepting situations and acknowledges the continual fluctuation of emotions, often conflicting, without becoming entangled in them. Therapist-teachers assist patients in comprehending and embracing the fact that thinking is inherently complex. DBT, as a whole, encompasses a blend of scientific knowledge and practical application.
            </p>
          ),
                ...
                {service.subsections.map((subsection) => {
                  return (
                    <div className='p-5' key={subsection.title}>
                      ...
                      <p className='text-lg pt-2'>- DR. ROXANNE FLAHERTY</p>
