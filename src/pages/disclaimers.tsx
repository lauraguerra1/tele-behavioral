  ...
  return (
    <Layout smallScreen={smallScreen} menuOpen={menuOpen} openOrCloseMenu={openOrCloseMenu} updateNavOption={updateNavOption} navOption={navOption}>
      <div className='bg-white flex flex-col items-center pt-10 h-screen px-5'>
        ...
        <h2 className='text-center underline text-xl pt-10'>PROFESSIONAL DISCLOSURE</h2>
        <p className=' text-center pt-5'>Roxanne Flaherty, DNP, FNP-C, PMHNP-BC, is a California-licensed Nurse Practitioner practicing independently under AB 890 (B&P Code § 2837.103). Practice is regulated by the California Board of Registered Nursing. Dr. Flaherty is not a physician or surgeon.</p>
