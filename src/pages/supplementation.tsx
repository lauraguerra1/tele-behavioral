    ...
    <div className='fade-in'>
      <article className='bg-white bg-opacity-50 lg:bg-white'>
          <div className='bg-white flex flex-col pt-[20vh] items-center h-[90vh]'>
            <p className='p-5 text-lg p-0'>Service description coming soon!</p>
            <p className='p-5 text-lg p-0'>For now, please have browse our other services!</p>
            <Link className='cursor-pointer hover:scale-105 bg-slate-400 px-10 py-5 m-5 text-white text-xl' href='/' onClick={() => updateNavOption('services')}>SELL ALL SERVICES</Link>
          </div>
      </article>
    </div>
    </Layout>
